...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = { c.teal, c.mauve }, angle = 45 },
    ...
    dwindle = {
        -- pseudotile is toggled by the mainMod + P bind in keybinds.lua
    ...
    -- Group styling (catppuccin colours to match the borders)
    group = {
        col = {
            border_active = { colors = { c.teal, c.mauve }, angle = 45 },
        },
...
-- "Smart gaps" / "No gaps when only" - uncomment all if you want that.
